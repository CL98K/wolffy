...
(declaim (ftype (function (t &optional (:env hash-table) (:stream wo-io:binary-stream) (:obj t)) t) perform-op) (inline perform-op))
(defun perform-op (op-code &optional env stream obj)
...
(macrolet ((add-op (name code doc)
  ...
  (add-op +lsp-cons+         (type-to-code (cons 1 2)) "")
